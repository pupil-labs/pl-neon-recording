...
def get_version(dist: str = "pupil-labs-neon-recording") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["pupil-labs-neon-recording"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("PUPIL_LABS_NEON_RECORDING")]]
    return Environment(
